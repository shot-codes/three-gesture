...
var ModuleFactory = (() => {
  ...
  return function (ModuleFactory) {
    ...
    function JsOnUint8ClampedArrayImageListener(
      output_stream_name,
      binary_ptr,
      binary_size,
      width,
    ...
    function JsOnUint8ClampedArrayImageVectorListener(
      output_stream_name,
      binary_ptr,
      binary_size,
      width,
    ...
    function _wgpuDeviceCreateBindGroup(deviceId, descriptor) {
      function makeEntry(entryPtr) {
        ...
        if (bufferId) {
          ...
          var size =
            size_high === -1 && size_low === -1 ? undefined : size_high * 4294967296 + size_low;
          return {
            binding: binding,
            resource: {
    ...
    var asmLibraryArg = {
      ...
      Ja: JsOnSimpleListenerBinaryArray,
      ...
      b: _glBindTexture,
      x: _glBindVertexArray,
      wa: _glBlendEquation,
      bc: _glBlendFunc,
      s: _glBufferData,
      B: _glClear,
      ac: _glClearColor,
      Ob: _glClientWaitSync,
      va: _glCompileShader,
      ua: _glCreateProgram,
      ta: _glCreateShader,
      I: _glDeleteBuffers,
      ...
      L: _glViewport,
      Mb: mediapipe_create_utility_canvas2d,
      Lb: _mediapipe_find_canvas_event_target,
      Kb: mediapipe_import_external_texture,
      Jb: _mediapipe_webgl_tex_image_drawable,
      Kc: _proc_exit,
      S: _strftime,
      Ib: _strftime_l,
      Hb: _wgpuBindGroupLayoutRelease,
      Gb: _wgpuBindGroupRelease,
      Fb: _wgpuBufferGetMappedRange,
      Eb: _wgpuBufferReference,
      Db: _wgpuBufferRelease,
      Cb: _wgpuBufferUnmap,
      Bb: _wgpuCommandBufferRelease,
      Ab: _wgpuCommandEncoderBeginComputePass,
      zb: _wgpuCommandEncoderBeginRenderPass,
      yb: _wgpuCommandEncoderCopyBufferToTexture,
      xb: _wgpuCommandEncoderCopyTextureToTexture,
      wb: _wgpuCommandEncoderFinish,
      vb: _wgpuCommandEncoderRelease,
      ub: _wgpuComputePassEncoderDispatchWorkgroups,
      tb: _wgpuComputePassEncoderEnd,
      sb: _wgpuComputePassEncoderRelease,
      rb: _wgpuComputePassEncoderSetBindGroup,
      qb: _wgpuComputePassEncoderSetPipeline,
      pb: _wgpuComputePipelineGetBindGroupLayout,
      ob: _wgpuComputePipelineRelease,
      nb: _wgpuDeviceCreateBindGroup,
      mb: _wgpuDeviceCreateBuffer,
      lb: _wgpuDeviceCreateCommandEncoder,
      kb: _wgpuDeviceCreateComputePipeline,
      jb: _wgpuDeviceCreateRenderPipeline,
      ib: _wgpuDeviceCreateSampler,
      hb: _wgpuDeviceCreateShaderModule,
      gb: _wgpuDeviceCreateTexture,
      fb: _wgpuDeviceGetQueue,
      eb: _wgpuDeviceReference,
      db: _wgpuDeviceRelease,
      cb: _wgpuPipelineLayoutRelease,
      bb: _wgpuQuerySetRelease,
      ab: _wgpuQueueRelease,
      $a: _wgpuQueueSubmit,
      Nb: _wgpuQueueWriteBuffer,
      _a: _wgpuRenderPassEncoderDraw,
      Za: _wgpuRenderPassEncoderEnd,
      Ya: _wgpuRenderPassEncoderRelease,
      Xa: _wgpuRenderPassEncoderSetBindGroup,
      Wa: _wgpuRenderPassEncoderSetPipeline,
      Va: _wgpuRenderPipelineGetBindGroupLayout,
      Ua: _wgpuRenderPipelineRelease,
      Ta: _wgpuSamplerReference,
      Sa: _wgpuSamplerRelease,
      Ra: _wgpuShaderModuleReference,
      Qa: _wgpuShaderModuleRelease,
      Pa: _wgpuTextureCreateView,
      Oa: _wgpuTextureDestroy,
      Na: _wgpuTextureReference,
      Ma: _wgpuTextureRelease,
      La: _wgpuTextureViewReference,
    ...
    var ___wasm_call_ctors = (Module["___wasm_call_ctors"] = function () {
      return (___wasm_call_ctors = Module["___wasm_call_ctors"] = Module["asm"]["kd"]).apply(
        null,
        arguments
      );
    });
    ...
    var ___errno_location = (Module["___errno_location"] = function () {
      return (___errno_location = Module["___errno_location"] = Module["asm"]["sd"]).apply(
        null,
        arguments
      );
    });
    ...
    var ___getTypeName = (Module["___getTypeName"] = function () {
      return (___getTypeName = Module["___getTypeName"] = Module["asm"]["fe"]).apply(
        null,
        arguments
      );
    });
    ...
    var ___start_em_js = (Module["___start_em_js"] = 999660);

    var ___stop_em_js = (Module["___stop_em_js"] = 1006222);
