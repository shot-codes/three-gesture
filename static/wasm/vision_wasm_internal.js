...
var ModuleFactory = (() => {
  ...
  return function (ModuleFactory) {
    ...
    var asmLibraryArg = {
      ...
      La: JsOnSimpleListenerBinaryArray,
      ...
      M: _glViewport,
      Ob: mediapipe_create_utility_canvas2d,
      Nb: _mediapipe_find_canvas_event_target,
      Mb: mediapipe_import_external_texture,
      Lb: _mediapipe_webgl_tex_image_drawable,
      Mc: _proc_exit,
      W: _strftime,
      Kb: _strftime_l,
      Jb: _wgpuBindGroupLayoutRelease,
      Ib: _wgpuBindGroupRelease,
      Hb: _wgpuBufferGetMappedRange,
      Gb: _wgpuBufferReference,
      Fb: _wgpuBufferRelease,
      Eb: _wgpuBufferUnmap,
      Db: _wgpuCommandBufferRelease,
      Cb: _wgpuCommandEncoderBeginComputePass,
      Bb: _wgpuCommandEncoderBeginRenderPass,
      Ab: _wgpuCommandEncoderCopyBufferToTexture,
      zb: _wgpuCommandEncoderCopyTextureToTexture,
      yb: _wgpuCommandEncoderFinish,
      xb: _wgpuCommandEncoderRelease,
      wb: _wgpuComputePassEncoderDispatchWorkgroups,
      vb: _wgpuComputePassEncoderEnd,
      ub: _wgpuComputePassEncoderRelease,
      tb: _wgpuComputePassEncoderSetBindGroup,
      sb: _wgpuComputePassEncoderSetPipeline,
      rb: _wgpuComputePipelineGetBindGroupLayout,
      qb: _wgpuComputePipelineRelease,
      pb: _wgpuDeviceCreateBindGroup,
      ob: _wgpuDeviceCreateBuffer,
      nb: _wgpuDeviceCreateCommandEncoder,
      mb: _wgpuDeviceCreateComputePipeline,
      lb: _wgpuDeviceCreateRenderPipeline,
      kb: _wgpuDeviceCreateSampler,
      jb: _wgpuDeviceCreateShaderModule,
      ib: _wgpuDeviceCreateTexture,
      hb: _wgpuDeviceGetQueue,
      gb: _wgpuDeviceReference,
      fb: _wgpuDeviceRelease,
      eb: _wgpuPipelineLayoutRelease,
      db: _wgpuQuerySetRelease,
      cb: _wgpuQueueRelease,
      bb: _wgpuQueueSubmit,
      Pb: _wgpuQueueWriteBuffer,
      ab: _wgpuRenderPassEncoderDraw,
      $a: _wgpuRenderPassEncoderEnd,
      _a: _wgpuRenderPassEncoderRelease,
      Za: _wgpuRenderPassEncoderSetBindGroup,
      Ya: _wgpuRenderPassEncoderSetPipeline,
      Xa: _wgpuRenderPipelineGetBindGroupLayout,
      Wa: _wgpuRenderPipelineRelease,
      Va: _wgpuSamplerReference,
      Ua: _wgpuSamplerRelease,
      Ta: _wgpuShaderModuleReference,
      Sa: _wgpuShaderModuleRelease,
      Ra: _wgpuTextureCreateView,
      Qa: _wgpuTextureDestroy,
      Pa: _wgpuTextureReference,
      Oa: _wgpuTextureRelease,
      Na: _wgpuTextureViewReference,
    ...
    var ___wasm_call_ctors = (Module["___wasm_call_ctors"] = function () {
      return (___wasm_call_ctors = Module["___wasm_call_ctors"] = Module["asm"]["md"]).apply(
        null,
        arguments
      );
    });
    ...
    var ___errno_location = (Module["___errno_location"] = function () {
      return (___errno_location = Module["___errno_location"] = Module["asm"]["ud"]).apply(
        null,
        arguments
      );
    });
    ...
    var ___getTypeName = (Module["___getTypeName"] = function () {
      return (___getTypeName = Module["___getTypeName"] = Module["asm"]["he"]).apply(
        null,
        arguments
      );
    });
